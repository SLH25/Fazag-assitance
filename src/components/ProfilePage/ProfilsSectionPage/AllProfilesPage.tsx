...
const AllProfilesPage = () => {
  ...
  const filteredProfil = useMemo (()=>{
    ...
    return PROFILES.filter(Profil=>
      ...
      Profil.role.toLowerCase().includes(query) ||
      Profil.location?.toLowerCase().includes(query) 
    );
  },[q])
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">
            Tous Nos <span className="text-emerald-500">Talents</span> Étoiles
          </h2>
         ...
         <div className="mb-6">
          <input
            ...
            placeholder="Rechercher par nom, rôle, compétence ou lieu..."
